  ...
  extends ContentProvider
{
  ...
  private static HashMap<String, q> c = new HashMap();
  private q d;
  ...
  /* Error */
  private static q a(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: getstatic 39	android/support/v4/content/FileProvider:c	Ljava/util/HashMap;
    //   3: astore 5
    //   5: aload 5
    //   7: monitorenter
    //   8: getstatic 39	android/support/v4/content/FileProvider:c	Ljava/util/HashMap;
    //   11: aload_1
    //   12: invokevirtual 58	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   15: checkcast 47	android/support/v4/content/q
    //   18: astore 4
    //   20: aload 4
    //   22: astore_3
    //   23: aload 4
    //   25: ifnonnull +321 -> 346
    //   28: new 60	android/support/v4/content/r
    //   31: dup
    //   32: aload_1
    //   33: invokespecial 61	android/support/v4/content/r:<init>	(Ljava/lang/String;)V
    //   36: astore 4
    //   38: aload_0
    ...
    //   97: astore 8
    //   99: aload 4
    //   101: getfield 97	android/support/v4/content/r:a	Ljava/util/HashMap;
    //   104: aload 7
    //   106: aload 8
    ...
    //   168: ifeq +53 -> 221
    //   171: getstatic 33	android/support/v4/content/FileProvider:b	Ljava/io/File;
    //   174: iconst_1
    //   175: anewarray 17	java/lang/String
    //   178: dup
    //   179: iconst_0
    //   180: aload 8
    //   182: aastore
    ...
    //   234: iconst_1
    //   235: anewarray 17	java/lang/String
    //   238: dup
    //   239: iconst_0
    //   240: aload 8
    //   242: aastore
    ...
    //   250: ldc -113
    //   252: aload_3
    //   253: invokevirtual 125	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   256: ifeq +23 -> 279
    //   259: aload_0
    //   260: invokevirtual 146	android/content/Context:getCacheDir	()Ljava/io/File;
    //   263: iconst_1
    //   264: anewarray 17	java/lang/String
    //   267: dup
    //   268: iconst_0
    //   269: aload 8
    //   271: aastore
    ...
    //   279: ldc -108
    //   281: aload_3
    //   282: invokevirtual 125	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   285: ifeq +66 -> 351
    //   288: invokestatic 153	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   291: iconst_1
    //   292: anewarray 17	java/lang/String
    //   295: dup
    //   296: iconst_0
    //   297: aload 8
    //   299: aastore
    ...
    //   332: athrow
    //   333: getstatic 39	android/support/v4/content/FileProvider:c	Ljava/util/HashMap;
    //   336: aload_1
    //   337: aload 4
    //   339: invokevirtual 101	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   342: pop
    //   343: aload 4
    //   345: astore_3
    //   346: aload 5
