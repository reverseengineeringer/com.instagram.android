...
final class e
{
  ...
  private static long a(RandomAccessFile paramRandomAccessFile, c paramc)
  {
    ...
    paramc = new byte['䀀'];
    for (i = paramRandomAccessFile.read(paramc, 0, i); i != -1; i = paramRandomAccessFile.read(paramc, 0, (int)Math.min(16384L, l)))
    {
      localCRC32.update(paramc, 0, i);
      l -= i;
      if (l == 0L) {
        break;
      }
  ...
  private static c a(RandomAccessFile paramRandomAccessFile)
  {
    long l1 = 0L;
